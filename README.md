...
A multiplayer first-person shooter game. Different input devices are supported, including Kinect, Xbox controllers, Leap Motion, and VR glasses. (Each input device lives on a separate branch; *those are not maintained since 2020, use at your own risk*.)
...
> **Note:** The experimental Unity → Unreal Engine 5 (C++) migration (Source/, MultiplayerFPS.uproject, and its documentation) was removed during repository cleanup. The full migration work remains available in git history (see the commit titled *UnrealMigration*).

## Requirement

[Unity 6000.6.0f1 (Unity 6 LTS)](https://unity.com/releases/editor/whats-new/6000.0.26)
